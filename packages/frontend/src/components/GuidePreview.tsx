...
import { GuideExportButtons } from "./GuideExportButtons";
...
export const GuidePreview: React.FC = () => {
  ...
  if (!generatedGuide) {
    // Don't show empty state when modal is open
    if (isCreateModalOpen) {
      return (
        <div className="bg-white rounded-lg shadow-md p-6 h-full flex items-center justify-center">
          <div className="text-center py-12">
            <p className="text-sm text-gray-500">
              Configure your new guide in the modal above
            </p>
          </div>
        </div>
      );
      ...
      <div className="bg-white rounded-lg shadow-md p-6 h-full flex items-center justify-center">
        <div className="text-center py-12">
          ...
          <p className="mt-1 text-sm text-gray-500 mb-4">
            Click "New Guide" to create your first guide
          </p>
          <button
            onClick={() => {
            ...
            className="mt-4 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold transition-colors flex items-center space-x-2 mx-auto"
          >
            <svg
              className="w-5 h-5"
              fill="none"
  ...
  return (
    <div className="relative bg-white rounded-lg shadow-md overflow-hidden flex flex-col h-full">
      {/* Export Buttons - Sticky on right */}
      <GuideExportButtons />
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4 flex-shrink-0">
        <div className="flex items-start justify-between">
          ...
          <button
            ...
            className="ml-4 px-4 py-2 bg-white/20 hover:bg-white/30 text-white rounded-lg font-semibold transition-colors flex items-center space-x-2 whitespace-nowrap"
          >
            <svg
              className="w-5 h-5"
              fill="none"
      ...
      {/* Content - scrollable, with padding for chat */}
      <div className="flex-1 overflow-y-auto p-6 pb-96 pr-20">
